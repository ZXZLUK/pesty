...
/// the iOS app ships a byte-identical copy (ClipBarKit/Sync/CloudKitSchema.swift).
/// Any change here must land on both platforms simultaneously.
enum CKSchema {
    static let containerID = "iCloud.com.zxzluk.clipbar"
    static let zoneName = "ClipBarZone"
    ...
    /// after successful sends (Amendment 11). Mac base: Application Support/ClipBar.
    static var tempAssetDir: URL {
        FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask)[0]
            .appendingPathComponent("ClipBar/ck-tmp", isDirectory: true)
    }
