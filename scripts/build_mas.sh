...
PKG="packaging/ClipBar-MAS-$VERSION.pkg"
ENT="packaging/ClipBar-MAS.entitlements"
PROFILE="${PROFILE:-packaging/ClipBar_MAS.provisionprofile}"
...
cp "$BIN" "$APP/Contents/MacOS/ClipBar"
cp packaging/ClipBar.icns "$APP/Contents/Resources/ClipBar.icns"
...
codesign --force --timestamp --entitlements "$ENT" --sign "$APP_IDENTITY" "$APP/Contents/MacOS/ClipBar"
